    ...
    private:
      ...
      static void __telnetConnectionHandler__ (TcpConnection *connection, void *thisTelnetServer) { // connectionHandler callback function
        ...
        String cmdLine;
          ...
          tsp = {tsp.userName, "", "", tsp.userName == "root" ? (char *) "\r\n# " : (char *) "\r\n$ ", connection, 0, 0, 0, 0};
          tsp.workingDir = tsp.homeDir = getUserHomeDirectory (tsp.userName);          
                          ...
                          if (c == 255) { // IAC
                            ...
                            if (c == 250) { // SB
                              ...
                              if (c == 31) { // NAWS
                                ...
                                // Serial.printf ("[%10lu] [telnet] client window size %i %i   %i %i\n", millis (), col1, col2, row1, row2);
                              }
                            }
                          }
