 ...
 * INSTRUCTIONS
 * 
 *  Run A_kind_of_esp32_OS_template the first time with FILE_SYSTEM_MOUNT_METHOD == FORMAT_IF_MOUNT_FAILS or FORMAT_BEFORE_MOUNT
 ...
 */
  ...
  #define FORMAT_BEFORE_MOUNT       1                             // this option is normally used ony the first time you run A_kind_of_est32_OS_template on ESP32
  #define FORMAT_IF_MOUNT_FAILS     2                             // this option is normally used ony the first time you run A_kind_of_est32_OS_template on ESP32
